...
POST_BODY_MD = """
My wife told me this on my birthday (yesterday) and I think – I need to improve my work-life balance. 
...
def experiment_page():
    ...
    with st.form("comment_form", clear_on_submit=False):
        comment_txt = st.text_area(
            ...
            placeholder=(
                "Minimum 50 words.\n"
                "Tip: How would you comment on David’s thread about his work life balance difficulties?"
            ),
...
def survey_page():
    ...
    with st.form("survey_form"):
        ...
        gv2 = likert7(
            "It is common for men entrepreneurs to experience what this person talked about in the venturing process.",
            "gv2")
        gv3 = likert7(
            "Men entrepreneurs are likely to experience what this person talked about in the venturing process.", "gv3")
